...
public class AppStatics {
    ...
    public static final List<EOpType> ASSM_OPERATIONS =
            Arrays.asList(DETAIL, ASSM, PACK,
                    ...
                    EL_MOUNT_ON_SCREWS_NO_DISASSM_2, EL_MOUNT_ON_SCREWS_NO_DISASSM_4, EL_MOUNT_ON_SCREWS_WITH_DISASSM_2, EL_MOUNT_ON_SCREWS_WITH_DISASSM_4,
                    EL_MOUNT_ON_VSHG, EL_CONNECT_DEVICE_MORTISE_CONTACT, EL_CONNECT_DEVICE_SPRING_CLAMP, EL_CONNECT_DEVICE_CLAMPING_SCREW, EL_CONNECT_DEVICE_VSHG,
                    EL_CUT_CABLE_HANDLY_MC6, EL_CUT_CABLE_HANDLY_MC15, EL_CUT_CABLE_HANDLY_SC,
                    EL_CUT_CABLE_ON_MACHINE, EL_CUT_METAL_SLEEVE, EL_CUT_CABLE_CHANNEL,
