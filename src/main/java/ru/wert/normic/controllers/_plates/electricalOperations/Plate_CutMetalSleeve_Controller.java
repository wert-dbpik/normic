 ...
 */
public class Plate_CutMetalSleeve_Controller extends AbstractOpPlate {
    ...
    private OpCutMetalSleeve opData;
    ...
    public String helpText() {
        return String.format("Резка металлорукава Д15 мм за %s мин/рез,\n" +
                        "\n" +
