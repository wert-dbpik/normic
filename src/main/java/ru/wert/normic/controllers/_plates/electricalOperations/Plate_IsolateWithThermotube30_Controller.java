package ru.wert.normic.controllers._plates.electricalOperations;
 ...
 */
public class Plate_IsolateWithThermotube30_Controller extends AbstractOpPlate {
    ...
    private OpIsolateWithThermTube30 opData;
    ...
    public void countNorm(OpData data){
        opData = (OpIsolateWithThermTube30) data;
    ...
    public String helpText() {
        return String.format("Изоляция провода термоизоляционной трубкой 10-30 мм за %s мин/место,\n" +
                        "\n" +
