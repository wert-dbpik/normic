 ...
 */
public class Plate_MountOnScrewsNoDisAssm4_Controller extends AbstractOpPlate {
    ...
    private OpMountOnScrewsNoDisAssm4 opData;
    ...
    public void countNorm(OpData data){
        opData = (OpMountOnScrewsNoDisAssm4) data;
