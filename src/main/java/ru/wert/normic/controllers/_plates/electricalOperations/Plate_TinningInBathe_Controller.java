 ...
 * ЛУЖЕНИЕ В ВАННОЧКЕ
 */
public class Plate_TinningInBathe_Controller extends AbstractOpPlate {
    ...
    private OpTinningInBathe opData;
    ...
    public String helpText() {
        return String.format("Лужение в ванночке за %s мин/наконечник,\n" +
                        "\n" +
