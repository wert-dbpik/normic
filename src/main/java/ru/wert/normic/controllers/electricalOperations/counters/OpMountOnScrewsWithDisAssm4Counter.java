...
import static ru.wert.normic.settings.NormConstants.MOUNT_ON_2_SCREWS_WITH_DISASSM;
import static ru.wert.normic.settings.NormConstants.MOUNT_ON_4_SCREWS_WITH_DISASSM;
...
public class OpMountOnScrewsWithDisAssm4Counter implements NormCounter{
    ...
    public OpData count(OpData data){
        ...
        double timeOp =  fourScrews * MOUNT_ON_4_SCREWS_WITH_DISASSM * k;   //мин
