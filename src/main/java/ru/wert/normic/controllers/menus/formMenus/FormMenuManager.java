...
import ru.wert.normic.controllers._plates.PlateEmptyController;
import ru.wert.normic.controllers._plates.PlateErrorController;
import ru.wert.normic.controllers._forms.TotalCounter;
import ru.wert.normic.controllers._plates.assembling.*;
import ru.wert.normic.controllers._plates.electricalOperations.*;
import ru.wert.normic.controllers._plates.listOperations.PlateBendController;
import ru.wert.normic.controllers._plates.listOperations.PlateCuttingController;
import ru.wert.normic.controllers._plates.locksmith.*;
import ru.wert.normic.controllers._plates.paint.PlatePaintDetailController;
import ru.wert.normic.controllers._plates.simpleOperations.PlateSimpleOperationController;
import ru.wert.normic.controllers._plates.packing.*;
import ru.wert.normic.controllers._plates.paint.PlatePaintAssmController;
import ru.wert.normic.controllers._plates.paint.PlatePaintOldController;
import ru.wert.normic.controllers._plates.singlePlates.PlateAssmController;
import ru.wert.normic.controllers._plates.singlePlates.PlateDetailController;
import ru.wert.normic.controllers._plates.singlePlates.PlatePackController;
import ru.wert.normic.controllers._plates.turning.*;
import ru.wert.normic.controllers._plates.welding.*;
