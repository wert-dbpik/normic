...
public enum EOpType {
    ...
    EL_MOUNT_ON_SCREWS_WITH_DISASSM_2   ("На 2 винта",                          OpMountOnScrewsWithDisAssm2.class,      new Image("/pics/opLogos/lamp.png"),       new OpMountOnScrewsWithDisAssm2Counter()),      //Установка на 2 винта с разборкой корпуса_2
    EL_MOUNT_ON_SCREWS_WITH_DISASSM_4   ("На 4 винта",                          OpMountOnScrewsWithDisAssm4.class,      new Image("/pics/opLogos/lamp.png"),       new OpMountOnScrewsWithDisAssm4Counter()),      //Установка на 2 винта с разборкой корпуса_2
