...
public class ConstantsController {
    ...
    public void fillTextFieldsWithData() {
        ...
        tfEL_MOUNT_ON_SCREWS_NO_DISASSM_2.setText(DECIMAL_FORMAT.format(MOUNT_ON_SCREWS_NO_DISASSM_2).trim());
        tfEL_MOUNT_ON_SCREWS_NO_DISASSM_4.setText(DECIMAL_FORMAT.format(MOUNT_ON_SCREWS_NO_DISASSM_4).trim());
        tfEL_MOUNT_ON_SCREWS_WITH_DISASSM_2.setText(DECIMAL_FORMAT.format(MOUNT_ON_SCREWS_WITH_DISASSM_2).trim());
        tfEL_MOUNT_ON_SCREWS_WITH_DISASSM_4.setText(DECIMAL_FORMAT.format(MOUNT_ON_SCREWS_WITH_DISASSM_4).trim());
        tfEL_MOUNT_ON_VSHG.setText(DECIMAL_FORMAT.format(MOUNT_ON_VSHG).trim());
        tfEL_CONNECT_DEVICE_MORTISE_CONTACT.setText(DECIMAL_FORMAT.format(CONNECT_DEVICE_MORTISE_CONTACT).trim());
        tfEL_CONNECT_DEVICE_SPRING_CLAMP.setText(DECIMAL_FORMAT.format(CONNECT_DEVICE_SPRING_CLAMP).trim());
        tfEL_CONNECT_DEVICE_CLAMPING_SCREW.setText(DECIMAL_FORMAT.format(CONNECT_DEVICE_CLAMPING_SCREW).trim());
        tfEL_CONNECT_DEVICE_VSHG.setText(DECIMAL_FORMAT.format(CONNECT_DEVICE_VSHG).trim());
        tfEL_CUT_CABLE_HANDLY_MC6.setText(DECIMAL_FORMAT.format(CUT_CABLE_HANDLY_MC6).trim());
        tfEL_CUT_CABLE_HANDLY_MC15.setText(DECIMAL_FORMAT.format(CUT_CABLE_HANDLY_MC15).trim());
        tfEL_CUT_CABLE_HANDLY_SC.setText(DECIMAL_FORMAT.format(CUT_CABLE_HANDLY_SC).trim());
        tfEL_CUT_CABLE_ON_MACHINE.setText(DECIMAL_FORMAT.format(CUT_CABLE_ON_MACHINE).trim());
        tfEL_CUT_METAL_SLEEVE.setText(DECIMAL_FORMAT.format(CUT_METAL_SLEEVE).trim());
        tfEL_CUT_CABLE_CHANNEL.setText(DECIMAL_FORMAT.format(CUT_CABLE_CHANNEL).trim());
        ...
        tfEL_MARKING.setText(DECIMAL_FORMAT.format(MARKING).trim());
        tfEL_MOUNT_OF_SIGNAL_EQUIP.setText(DECIMAL_FORMAT.format(MOUNT_OF_SIGNAL_EQUIP).trim());
        tfEL_SOLDERING.setText(DECIMAL_FORMAT.format(SOLDERING).trim());
        tfEL_MOUNT_OF_CABLE_ENTRIES.setText(DECIMAL_FORMAT.format(MOUNT_OF_CABLE_ENTRIES).trim());
        tfEL_FIX_OF_CABLES.setText(DECIMAL_FORMAT.format(FIX_OF_CABLES).trim());
        tfEL_ISOLATE_WITH_THERM_TUBE10.setText(DECIMAL_FORMAT.format(ISOLATE_WITH_THERM_TUBE10).trim());
        tfEL_ISOLATE_WITH_THERM_TUBE30.setText(DECIMAL_FORMAT.format(ISOLATE_WITH_THERM_TUBE30).trim());
